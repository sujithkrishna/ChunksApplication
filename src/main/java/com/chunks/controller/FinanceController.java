...
public class FinanceController {
	...
	@PostMapping(path = "/updateFinance")
	public String handleUpdateFinance(@RequestParam String financeType,
		...
		FinanceCompositeKey financeKey = new FinanceCompositeKey();
		
        
		financeKey.setFinanceType(financeType);
		financeKey.setFinanceName(financeName);
		financeKey.setFinanceOwner(financeOwnerName);
        
		CreateFinanceModel financeModel= new CreateFinanceModel();
		financeModel.setId(financeKey);
		...
		try {
			financeService.updateFinance(financeModel);
	        redirectAttributes.addFlashAttribute("success", "Finance Updated successfully!");
